import { __assign, __extends, __rest, __read, __spreadArray } from 'tslib';
import React, { forwardRef, useRef, useEffect, useState, useLayoutEffect, useImperativeHandle, createRef, Component, useMemo } from 'react';
...
function useCropperImage(options) {
    ...
    var _c = __read(useState(null), 2), image = _c[0], setImage = _c[1];
        ...
        if (currentSrc.current !== src) {
            ...
            if (src) {
                ...
                Promise.all(promises)
                    ...
                    var _a = __read(responses, 1), image = _a[0];
                    if (currentSrc.current === src) {
                        setImage(image);
...
function useForceRerender() {
    var _a = __read(useState({}), 2); _a[0]; var setTick = _a[1];
    return function () {
        setTick({});
    };
}
...
function useCropperState(props, settings) {
    ...
    var cropper = useRef(new CropperInstance({
        getProps: getProps,
        setData: function () {
            rerender();
        },
...
var StretchableBoundary = forwardRef(function (_a, ref) {
    ...
    return (React.createElement("div", { ref: boundaryRef, style: style, className: cn('advanced-cropper-boundary', className) },
        React.createElement("div", { ref: stretcherRef, className: cn(['advanced-cropper-boundary__stretcher', stretcherClassName]) }),
        React.createElement("div", { className: cn(['advanced-cropper-boundary__content', contentClassName]) }, children)));
});
...
var CropperFade = function (_a) {
    ...
    return (React.createElement("div", { style: style, className: cn(className, 'advanced-cropper-fade', Boolean(visible) && 'advanced-cropper-fade--visible') }, children));
};
...
var CropperWrapper = function (_a) {
    ...
    return (React.createElement("div", { className: cn(className, 'advanced-cropper-wrapper'), style: style },
        React.createElement(CropperFade, { visible: state && loaded, className: 'advanced-cropper-wrapper__fade' }, children)));
};
...
var CropperBackgroundImage = forwardRef(function (_a, ref) {
    ...
    return src ? (React.createElement("img", { key: src, ref: ref, className: cn('advanced-cropper-background-image', className), src: src, crossOrigin: crossOrigin === true ? 'anonymous' : crossOrigin || undefined, style: style, onMouseDown: preventDefault })) : null;
});
...
var CropperCanvas = forwardRef(function (_, ref) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("canvas", { className: "advanced-cropper-canvas", ref: canvasRef }),
        React.createElement("canvas", { className: "advanced-cropper-canvas", ref: spareCanvasRef })));
});
...
var DraggableElement = /** @class */ (function (_super) {
    ...
    DraggableElement.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cn('advanced-cropper-draggable-element', className), ref: this.container, onMouseOver: this.onMouseOver, onMouseLeave: this.onMouseLeave }, children));
    };
...
var LineWrapper = function (_a) {
    ...
    return (React.createElement(DraggableElement, { className: cn([
...
var SimpleLine = function (_a) {
    ...
    return (React.createElement(LineWrapper, { className: cn('advanced-cropper-simple-line-wrapper', wrapperClassName, (_b = {},
        ...
        React.createElement("div", { className: cn('advanced-cropper-simple-line', hover && 'advanced-cropper-simple-line--hover', defaultClassName, hover && hoverClassName, (_c = {},
...
var HandlerWrapper = function (_a) {
    ...
    var position = horizontalPosition || verticalPosition
        ...
        : null;
    return (React.createElement("div", { style: style, className: cn(className, 'advanced-cropper-handler-wrapper', position && "advanced-cropper-handler-wrapper--".concat(position), disabled && 'advanced-cropper-handler-wrapper--disabled') },
        React.createElement(DraggableElement, { className: 'advanced-cropper-handler-wrapper__draggable', disabled: disabled, onMove: onDrag, onMoveEnd: onDragEnd, onLeave: onLeave, onEnter: onEnter, activationDistance: 0 }, children)));
};
...
var SimpleHandler = function (_a) {
    ...
    return (React.createElement(HandlerWrapper, { style: wrapperStyle, className: cn('advanced-cropper-simple-handler-wrapper', wrapperClassName, verticalPosition && "advanced-cropper-simple-handler-wrapper--".concat(verticalPosition), horizontalPosition && "advanced-cropper-simple-handler-wrapper--".concat(horizontalPosition), horizontalPosition &&
            verticalPosition &&
        ...
        React.createElement("div", { className: cn('advanced-cropper-simple-handler', hover && 'advanced-cropper-simple-handler--hover', defaultClassName, hover && hoverClassName, (_b = {},
...
var BoundingBox = function (_a) {
    ...
    return (React.createElement("div", { className: cn('advanced-cropper-bounding-box', className), style: style },
        children,
        React.createElement("div", null, lineNodes.map(function (line) { return (React.createElement(line.component, { key: line.name, defaultClassName: line.className, hoverClassName: line.hoverClassName, wrapperClassName: line.wrapperClassName, position: line.name, disabled: line.disabled, onDrag: onHandlerDrag(line.horizontalPosition, line.verticalPosition), onDragEnd: onResizeEnd })); })),
        React.createElement("div", null, handlerNodes.map(function (handler) {
            var handlerElement = (React.createElement(handler.component, { defaultClassName: handler.className, hoverClassName: handler.hoverClassName, wrapperClassName: handler.wrapperClassName, horizontalPosition: handler.horizontalPosition, verticalPosition: handler.verticalPosition, disabled: handler.disabled, onDrag: onHandlerDrag(handler.horizontalPosition, handler.verticalPosition), onDragEnd: onResizeEnd }));
            return (React.createElement("div", { key: handler.name, className: handler.containerClassName }, handlerElement));
        }))));
};

var StencilOverlay = function (_a) {
    var className = _a.className, children = _a.children;
    return React.createElement("div", { className: cn('advanced-cropper-stencil-overlay', className) }, children);
};
...
var ArtificialTransition = function (_a) {
    ...
    useLayoutEffect(function () {
        if (!deepCompare(rememberedValues, values)) {
            ...
            var startValues_1 = transitionsActive
                ? __assign({}, transitionValues.current) : rememberedValues;
    ...
    return (React.createElement("div", { ref: root, className: cn('advanced-cropper-artificial-transition', className), style: rootStyle }, children));
};
...
var StencilWrapper = function (_a) {
    ...
    return (React.createElement(ArtificialTransition, { className: cn('advanced-cropper-stencil-wrapper', className), transitions: transitions, width: width, height: height, top: top, left: left }, children));
};
...
var StencilGrid = function (_a) {
    ...
    for (var i = 0; i < currentRows; i++) {
        ...
        for (var j = 0; j < currentColumns; j++) {
            cells.push(React.createElement("div", { key: j, className: cn('advanced-cropper-stencil-grid__cell', i === 0 && 'advanced-cropper-stencil-grid__cell--top', i === currentRows - 1 && 'advanced-cropper-stencil-grid__cell--bottom', j === 0 && 'advanced-cropper-stencil-grid__cell--left', j === currentColumns - 1 && 'advanced-cropper-stencil-grid__cell--right') }));
        }
        nodes.push(React.createElement("div", { key: i, className: 'advanced-cropper-stencil-grid__row' }, cells));
    }
    return (React.createElement("div", { className: cn('advanced-cropper-stencil-grid', visible && 'advanced-cropper-stencil-grid--visible', className) }, nodes));
};
...
var RectangleStencil = forwardRef(function (_a, ref) {
    ...
    return (state && (React.createElement(StencilWrapper, { className: cn('advanced-cropper-rectangle-stencil', movable && 'advanced-cropper-rectangle-stencil--movable', interactions.moveCoordinates && 'advanced-cropper-rectangle-stencil--moving', resizable && 'advanced-cropper-rectangle-stencil--resizable', interactions.resizeCoordinates && 'advanced-cropper-rectangle-stencil--resizing', interactions.moveCoordinates && movingClassName, interactions.resizeCoordinates && resizingClassName), width: width, height: height, left: left, top: top, transitions: transitions },
        React.createElement(BoundingBox, { className: cn(boundingBoxClassName, 'advanced-cropper-rectangle-stencil__bounding-box'), handlers: handlers, handlerComponent: handlerComponent, handlerClassNames: handlerClassNames, handlerWrapperClassNames: handlerWrapperClassNames, lines: lines, lineComponent: lineComponent, lineClassNames: lineClassNames, lineWrapperClassNames: lineWrapperClassNames, onResize: onResize, onResizeEnd: onResizeEnd, disabled: !resizable },
            React.createElement(DraggableElement, { disabled: !movable, onMove: onMove, onMoveEnd: onMoveEnd, className: cn('advanced-cropper-rectangle-stencil__draggable-area', draggableAreaClassName) },
                React.createElement(StencilOverlay, { className: cn('advanced-cropper-rectangle-stencil__overlay', overlayClassName) },
                    grid && (React.createElement(StencilGrid, { visible: cropper.hasInteractions(), columns: interactions.transformImage.rotate ? 9 : 3, rows: interactions.transformImage.rotate ? 9 : 3, className: cn('advanced-cropper-rectangle-stencil__grid', gridClassName) })),
                    React.createElement("div", { className: cn('advanced-cropper-rectangle-stencil__preview', previewClassName) })))))));
});
...
var TransformableImage = /** @class */ (function (_super) {
    __extends(TransformableImage, _super);
    ...
    TransformableImage.prototype.render = function () {
        ...
        return (React.createElement("div", { className: className, style: style, ref: this.container }, children));
    };
...
var AbstractCropperComponent = function (props, ref) {
    ...
    useImperativeHandle(mergeRefs([ref, cropperRef]), function () { return cropperInterface; });
    ...
    return (React.createElement(WrapperComponent, __assign({}, wrapperProps, { className: cn('advanced-cropper', className), loaded: loaded, cropper: cropperInterface, loading: loading, style: style }),
        React.createElement(StretchableBoundary, { ref: boundaryRef, stretchAlgorithm: boundaryStretchAlgorithm, sizeAlgorithm: boundarySizeAlgorithm, className: cn('advanced-cropper__boundary', boundaryClassName), stretcherClassName: cn('advanced-cropper__stretcher') },
            React.createElement(BackgroundWrapperComponent, __assign({}, backgroundWrapperProps, { cropper: cropperInterface, className: 'advanced-cropper__background-wrapper' }),
                React.createElement("div", { className: cn('advanced-cropper__background', backgroundClassName) }, cropper.getState() && (React.createElement(BackgroundComponent, __assign({}, backgroundProps, { ref: imageRef, crossOrigin: crossOrigin, cropper: cropperInterface, className: cn('advanced-cropper__image', imageClassName) })))),
                React.createElement(StencilComponent, __assign({}, stencilProps, { ref: stencilRef, cropper: cropperInterface, image: currentImage }))),
            canvas && React.createElement(CropperCanvas, { ref: canvasRef }))));
};
...
var FixedCropperComponent = function (props, ref) {
    var _a = splitAbstractCropperProps(props), settings = _a.settings, parameters = __rest(_a, ["settings"]);
    return (React.createElement(AbstractCropper, __assign({ postProcess: fixedStencil, stencilConstraints: fixedStencilConstraints }, parameters, { settings: __assign(__assign({ defaultSize: defaultSize, aspectRatio: aspectRatio, sizeRestrictions: withDefaultSizeRestrictions(sizeRestrictions) }, settings), { transformImage: __assign(__assign({}, settings.transformImage), { adjustStencil: false }) }), ref: ref })));
};
var FixedCropper = createCropper(FixedCropperComponent);

var CropperComponent = function (props, ref) {
    var _a = splitAbstractCropperProps(props), settings = _a.settings, postProcess = _a.postProcess, parameters = __rest(_a, ["settings", "postProcess"]);
    // Process the deprecated properties
    var _b = settings, stencilSize = _b.stencilSize, autoZoom = _b.autoZoom, actualSettings = __rest(_b, ["stencilSize", "autoZoom"]);
    ...
    if (!isUndefined(stencilSize)) {
        ...
        return (React.createElement(FixedCropper, __assign({ ref: ref, stencilSize: stencilSize }, actualSettings, parameters)));
    }
    return (React.createElement(AbstractCropper, __assign({}, parameters, { postProcess: postProcess, ref: ref, settings: actualSettings })));
};
...
var CircleStencil = forwardRef(function (_a, ref) {
    ...
    var _m = getStencilCoordinates(state), width = _m.width, height = _m.height, left = _m.left, top = _m.top;
    return (state && (React.createElement(StencilWrapper, { className: cn('advanced-cropper-circle-stencil', movable && 'advanced-cropper-circle-stencil--movable', interactions.moveCoordinates && 'advanced-cropper-circle-stencil--moving', resizable && 'advanced-cropper-circle-stencil--resizable', interactions.resizeCoordinates && 'advanced-cropper-circle-stencil--resizing', interactions.moveCoordinates && movingClassName, interactions.resizeCoordinates && resizingClassName), width: width, height: height, left: left, top: top, transitions: transitions },
        React.createElement(BoundingBox, { className: cn(boundingBoxClassName, 'advanced-cropper-circle-stencil__bounding-box'), handlers: handlers, handlerComponent: handlerComponent, handlerClassNames: handlerClassNames, handlerWrapperClassNames: handlerWrapperClassNames, lines: lines, lineComponent: lineComponent, lineClassNames: lineClassNames, lineWrapperClassNames: lineWrapperClassNames, onResize: onResize, onResizeEnd: onResizeEnd, disabled: !resizable },
            React.createElement(DraggableElement, { disabled: !movable, onMove: onMove, onMoveEnd: onMoveEnd, className: cn('advanced-cropper-circle-stencil__draggable-area', draggableAreaClassName) },
                React.createElement(StencilOverlay, { className: cn('advanced-cropper-circle-stencil__overlay', overlayClassName) },
                    grid && (React.createElement(StencilGrid, { visible: cropper.hasInteractions(), columns: interactions.transformImage.rotate ? 9 : 3, rows: interactions.transformImage.rotate ? 9 : 3, className: cn('advanced-cropper-circle-stencil__grid', gridClassName) })),
                    React.createElement("div", { className: cn('advanced-cropper-circle-stencil__preview', previewClassName) })))))));
});
...
var CropperPreview = function (_a) {
    ...
    var boundaryRef = useRef(null);
    var _c = __read(useState(null), 2), size = _c[0], setSize = _c[1];
    var _d = __read(useState(1), 2), coefficient = _d[0], setCoefficient = _d[1];
    ...
    return (React.createElement(StretchableBoundary, { ref: boundaryRef, stretchAlgorithm: stretchPreviewBoundary, className: cn(className, 'advanced-cropper-preview') },
        React.createElement("div", { className: cn(contentClassName, 'advanced-cropper-preview__content'), style: contentStyle },
            React.createElement("img", { src: image ? image.src : undefined, className: cn(imageClassName, 'advanced-cropper-preview__image', image && image.src && 'advanced-cropper-preview__image--visible'), style: imageStyle }))));
};

export { AbstractCropper$1 as AbstractCropper, Animation, BoundingBox, CircleStencil, Cropper, CropperBackgroundImage, CropperBackgroundWrapper, CropperCanvas, CropperFade, CropperInstance, CropperPreview, CropperWrapper, DraggableElement as DraggableArea, DraggableElement, FixedCropper, ImageRestriction, Priority, RectangleStencil, SetCoordinatesMode, SimpleHandler, SimpleLine, StencilOverlay, StencilWrapper, StretchableBoundary, TransformableImage, TransformableImageEvent, applyDirections, applyMove, applyScale, approximateSize, aspectRatioIntersection, calculateAreaSizeRestrictions, calculateSizeRestrictions, coordinatesToPositionRestrictions, copyState, createAspectRatio, createDefaultSettings, createImage, createState, debounce, deepClone, deepCompare, defaultAreaPositionRestrictions, defaultAreaSizeRestrictions, defaultPosition, defaultPositionRestrictions, defaultSize$1 as defaultSize, defaultStencilConstraints, defaultVisibleArea, diff, distance, drawCroppedArea, emptyCoordinates, fillBoundary, fillMoveDirections, fillResizeDirections, fitBoundary, fitCoordinates, fitDirections, fitToPositionRestrictions, fitToSizeRestrictions, fitVisibleArea, flipImageAlgorithm, getAreaPositionRestrictions, getAreaSizeRestrictions, getAspectRatio, getBackgroundStyle, getBrokenRatio, getCenter, getCloserAngle, getCloserSize, getCoefficient, getDefaultCoordinates, getDefaultVisibleArea, getDirectionNames, getImageStyle, getIntersections, getMinimumSize, getOptions, getPositionRestrictions, getPreviewStyle, getRoundedCoordinates, getSizeRestrictions, getStencilCoordinates, getStyleTransforms, getTransformedImageSize, getTransitionStyle, inverseMove, isArray, isArrayBufferLike, isBlob, isCardinalDirection, isConsistentPosition, isConsistentSize, isConsistentState, isCrossOriginURL, isDataUrl, isEqualState, isFunction, isGreater, isInitializedState, isLocal, isLower, isMouseEvent, isNaN, isNumber, isNumeric, isObject, isOrdinalDirection, isRoughlyEqual, isString, isTouchEvent, isUndefined, isWheelEvent, loadImage, maxScale, mergePositionRestrictions, mergeRefs, mergeSizeRestrictions, minScale, moveCoordinates, moveCoordinatesAlgorithm, moveToPositionRestrictions, normalizeCenter, normalizeFlip, normalizeImageTransform, normalizeMoveDirections, normalizeResizeDirections, parseNumber, pixelsRestrictions, positionToSizeRestrictions, prepareSource, promiseTimeout, ratio, reconcileSizeRestrictions, reconcileState, resizeCoordinates, resizeCoordinatesAlgorithm, resizeToSizeRestrictions, retrieveSizeRestrictions, rotateImageAlgorithm, rotatePoint, rotateSize, setBoundary, setCoordinates, setVisibleArea, sign, sizeDistance, stretchCropperBoundary, stretchPreviewBoundary, touchesToImageTransform, transformImage, transformImageAlgorithm, updateCanvas, useCropperImage, useCropperState, useMoveImageOptions, useScaleImageOptions, useUpdateEffect, useWindowResize, wheelEventToImageTransform, withDefaultAreaPositionRestrictions, withDefaultAreaSizeRestrictions, withDefaultPositionRestrictions, withDefaultSizeRestrictions };
